...
export default function CommandCenter() {
  ...
  const [activeTab, setActiveTab] = useState<'fleet' | 'profiles' | 'logs'>('fleet');
                ...
                <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden">
                  <div className="p-8 border-b border-slate-100 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-slate-400 font-medium">Complete database of all authenticated profiles.</p>
                    </div>
                      ...
                      <tbody className="divide-y divide-slate-100">
                        {profiles.map((profile) => (
                          <tr key={profile.id} className="hover:bg-slate-50/50 transition-colors group">
                            <td className="px-8 py-5 text-xs font-mono text-slate-400">{profile.id.slice(0, 8)}...</td>
                            <td className="px-8 py-5 text-sm font-bold text-slate-900">{profile.name}</td>
                            <td className="px-8 py-5 text-sm font-medium text-slate-500">{profile.email}</td>
              ...
              >
                <div className="bg-white rounded-[2.5rem] border border-slate-200 shadow-sm overflow-hidden">
                  <div className="p-8 border-b border-slate-100">
                    <h3 className="text-xl font-black text-slate-900">Intelligence Stream</h3>
                    <p className="text-sm text-slate-400 font-medium">Real-time location and status telemetry from the fleet.</p>
                  </div>
                  <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                      <thead>
                        <tr className="bg-slate-50/50">
                          ...
                          <th className="px-8 py-5 text-[10px] font-black uppercase tracking-widest text-slate-400">Coordinates</th>
                          ...
                          >
                            ...
                            <td className="px-8 py-5">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-sm font-bold text-slate-900">{log.devices?.model || 'Unknown Device'}</span>
                              </div>
                            </td>
                            ...
                            <td className="px-8 py-5">
                              <span className="px-2 py-1 bg-green-50 text-green-600 rounded-md text-[9px] font-black uppercase border border-green-100">
                                Recorded
                              </span>
                            </td>
                          </tr>
